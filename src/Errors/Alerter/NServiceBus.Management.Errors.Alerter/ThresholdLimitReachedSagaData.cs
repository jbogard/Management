...
{
    public class ThresholdLimitReachedSagaData : ISagaEntity
    {
        ...
        public Dictionary<string, int> TimesAlerted;
        
        public ThresholdLimitReachedSagaData()
        {
            ErrorsToAlert = new Dictionary<string, DateTime>();
            ErrorsToBeCleared = new Dictionary<string, DateTime>();
            TimesAlerted = new Dictionary<string, int>();
        }
